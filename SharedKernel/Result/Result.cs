...
public class Result<T> : IResult
{
  ...
  /// <summary>
  /// Represents a successful creation operation and accepts a value as the result of the operation
  /// </summary>
  /// <param name="value">Sets the Value property</param>
  /// <returns>A Result<typeparamref name="T"/></returns>
  ...
  {
    return new Result<T>(ResultStatus.Created, value) { SuccessMessage = successMessage };
  }
