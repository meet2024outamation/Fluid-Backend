...
namespace Fluid.Entities.Migrations.Core
{
    ...
    [Migration("20250923115952_initialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fluid.Entities.Entities.OrderFlow", b =>
                {
                    ...
                    b.HasIndex("OrderStatusId")
                        .HasDatabaseName("ix_order_flows_order_status_id");
            ...
            modelBuilder.Entity("Fluid.Entities.Entities.OrderStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Fluid.Entities.Entities.Order", b =>
                {
                    ...
                    b.HasOne("Fluid.Entities.Entities.OrderStatus", "OrderStatus")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Fluid.Entities.Entities.OrderFlow", b =>
                {
                    ...
                    b.HasOne("Fluid.Entities.Entities.OrderStatus", "OrderStatus")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_order_flows_order_statuses_order_status_id");
